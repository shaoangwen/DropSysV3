...
libraries/CMSIS/Device/ST/STM32F4xx/Source/Templates/gcc/%.o: ../libraries/CMSIS/Device/ST/STM32F4xx/Source/Templates/gcc/%.S
	arm-none-eabi-gcc -mcpu=cortex-m4 -mthumb -mfloat-abi=hard -mfpu=fpv4-sp-d16 -O0 -ffunction-sections -fdata-sections -Wall  -g -gdwarf-2 -x assembler-with-cpp -I"C:\home_of_wen\Documents\gobioX\Instruments\firmware\dsv3" -Xassembler -mimplicit-it=thumb -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
